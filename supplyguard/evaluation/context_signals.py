...
from supplyguard.evaluation.error_analysis import HIGH_NOISE_RULES, HIGH_RELIABILITY_RULES
from supplyguard.evaluation.reporting import compute_binary_metrics, malicious_prediction
...
def load_package_json(package_path: str | Path) -> dict[str, Any]:
    """Return parsed package.json data, or an empty dict when unavailable."""
